...
print (list(permutations([1, 'InterviewBit'], 1)))
print (list(permutations([1, 'InterviewBit'], 2)))
print (list(permutations([1, 'InterviewBit'], 3)))
...
len((list(permutations(range(4), 4))))
len(list(permutations(range(4), 3)))
...
# Item with id 10 comes first, followed by 2, 1, 4.
# So, print the item in order of its first occurence.
# Explanation 2:
