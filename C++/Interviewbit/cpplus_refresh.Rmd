...
## Exercise 6.1.2 Upper & Lower bound

You are given N **integers in sorted order** (not necessarily distinct). 
Also, you are given Q queries. In each query, check if x exist. Return leftmost index if present and rightmost ix if not that will keep the array sorted
